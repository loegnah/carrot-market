    ...
    <div className="px-4 py-10">
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              <div className="h-56 w-full mb-1 bg-slate-300 rounded-md" />
              <h3 className="text-sm text-gray-700 -mb-2 px-0.5">Galaxy S60</h3>
              <span className="text-xs font-bold text-gray-900 px-0.5">$6</span>
            </div>
          ))}
        </div>
      </div>
